...
DmOS
SW1POP57_CAIXA_AG51433-293 login: admin
Password:
Welcome to the DmOS CLI
admin connected from 127.0.0.1 using console on SW1POP57_CAIXA_AG51433-293
SW1POP57_CAIXA_AG51433-293# show running-config
...
!
mpls l2vpn
 vpls-group POP57_CAIXA_POP02_TELIUM
  vpn VSI_23_POP02-57
   vfi
    pw-type ethernet
...
interface ten-gigabit-ethernet 1/1/2
 description PTP_SW1POP57_PX02_SW1_POP02_PX02
 no shutdown
 no negotiation
 duplex full
 speed 10G
...
interface ten-gigabit-ethernet 1/1/4
 description PTP_SW1POP57_PX04_SW_CLIENTE_PX02
 no shutdown
 no negotiation
 duplex full
 speed 10G
...
hostname SW1POP57_CAIXA_AG51433-293
