...
onu set gpon 1 onu 1 serial-number FHTT07D9FB08 meprof intelbras-default
onu set gpon 1 onu 2 serial-number FHTT2D2A7888 meprof intelbras-default
onu set gpon 1 onu 3 serial-number FHTT2393C54F meprof intelbras-default
onu set gpon 1 onu 7 serial-number ITBS2CCFE60B meprof intelbras-default
onu set gpon 1 onu 8 serial-number ZNTS2C173B50 meprof intelbras-default
onu set gpon 1 onu 10 serial-number ITBS2C70F60B meprof intelbras-default
onu set gpon 1 onu 11 serial-number ZNTS2CBEE267 meprof intelbras-default
onu set gpon 1 onu 12 serial-number ITBS2C9F71DA meprof intelbras-default
onu set gpon 1 onu 13 serial-number ITBS8B68480D meprof intelbras-default
onu set gpon 1 onu 14 serial-number ITBS5B0E7202 meprof intelbras-default
onu set gpon 1 onu 15 serial-number ITBS44A0FBB5 meprof intelbras-default
onu set gpon 2 onu 1 serial-number HWTCC126199D meprof intelbras-default
onu set gpon 2 onu 2 serial-number ITBSE8F801B0 meprof intelbras-default
onu set gpon 2 onu 3 serial-number ITBS441CB6F7 meprof intelbras-default
onu set gpon 2 onu 4 serial-number ITBS8BA5ACAD meprof intelbras-default
onu set gpon 2 onu 5 serial-number TKTHE600D378 meprof intelbras-default
onu set gpon 2 onu 7 serial-number ITBS0A84F522 meprof intelbras-1200r
onu set gpon 2 onu 8 serial-number ITBSE8F80179 meprof intelbras-default
onu set gpon 2 onu 9 serial-number ITBS44A108D9 meprof intelbras-r1
onu set gpon 2 onu 10 serial-number ITBS0D65E16C meprof intelbras-default
onu set gpon 2 onu 11 serial-number ITBS8B6A4EEF meprof intelbras-default
onu set gpon 2 onu 12 serial-number ITBSE8FEE011 meprof intelbras-default
onu set gpon 2 onu 13 serial-number ZNTS2C173710 meprof intelbras-default
onu set gpon 2 onu 14 serial-number ITBS443891EE meprof intelbras-default
onu set gpon 2 onu 15 serial-number ITBS5F554F69 meprof intelbras-default
onu set gpon 2 onu 16 serial-number ITBS0D54AE2C meprof intelbras-default
onu set gpon 2 onu 17 serial-number FSTTB81CF0E8 meprof intelbras-default
...
onu set gpon 3 onu 8 serial-number ITBS5B0E719A meprof intelbras-default
...
onu set gpon 3 onu 11 serial-number ITBS5B0E7257 meprof intelbras-default
...
onu set gpon 4 onu 1 serial-number ITBS0D7BFD0A meprof intelbras-default
onu set gpon 4 onu 2 serial-number FHTT9143FBA8 meprof intelbras-default
onu set gpon 4 onu 3 serial-number FHTT10527698 meprof intelbras-default
onu set gpon 4 onu 4 serial-number ITBS8BAC2964 meprof intelbras-default
onu set gpon 4 onu 5 serial-number ITBS44973C96 meprof intelbras-default
onu set gpon 4 onu 6 serial-number ITBS32B40E06 meprof intelbras-121ac
onu set gpon 4 onu 7 serial-number ITBS0A84F54F meprof intelbras-1200r
onu set gpon 4 onu 10 serial-number ZNTS2C0F7814 meprof intelbras-default
onu set gpon 4 onu 11 serial-number ITBS8B6C21CB meprof intelbras-default
onu set gpon 4 onu 12 serial-number ITBS0D2296F4 meprof intelbras-default
onu set gpon 4 onu 13 serial-number ZNTS2C54B7A7 meprof intelbras-default
onu set gpon 4 onu 15 serial-number ITBSAC4D0CA4 meprof intelbras-default
onu set gpon 4 onu 16 serial-number ZNTS3F81F6A3 meprof intelbras-default
onu set gpon 4 onu 17 serial-number ITBSE8F8D827 meprof intelbras-default
onu set gpon 5 onu 1 serial-number ZNTS2CC1B893 meprof intelbras-default
onu set gpon 5 onu 2 serial-number FSTT000066D3 meprof intelbras-default
onu set gpon 5 onu 3 serial-number ITBS5F79CA89 meprof intelbras-default
onu set gpon 5 onu 4 serial-number ITBS441CB5FF meprof intelbras-default
onu set gpon 5 onu 5 serial-number FSTTB81CF722 meprof intelbras-default
onu set gpon 5 onu 7 serial-number ITBS44A0FB5D meprof intelbras-default
onu set gpon 5 onu 8 serial-number ITBS2C863ED7 meprof intelbras-default
onu set gpon 5 onu 9 serial-number ITBS326A53B0 meprof intelbras-default
onu set gpon 5 onu 10 serial-number ITBS0A6E7038 meprof intelbras-r1
onu set gpon 7 onu 1 serial-number ITBS44389018 meprof intelbras-default
onu set gpon 7 onu 2 serial-number ITBS0A6E45DA meprof intelbras-default
onu set gpon 7 onu 3 serial-number FSTT0000E92F meprof intelbras-default
onu set gpon 7 onu 4 serial-number FSTTB81D0059 meprof intelbras-default
onu set gpon 8 onu 1 serial-number ITBSE8F6E6A2 meprof intelbras-default
onu set gpon 8 onu 2 serial-number FSTTB81D061D meprof intelbras-default
onu set gpon 8 onu 3 serial-number ITBS8BF23F33 meprof intelbras-default
onu set gpon 8 onu 4 serial-number ITBS0A6E722C meprof intelbras-default
onu set gpon 8 onu 5 serial-number FSTTB81CEBBD meprof intelbras-default
onu set gpon 8 onu 6 serial-number ITBS0D4DB9CD meprof intelbras-default
onu set gpon 8 onu 7 serial-number ZNTS2C20155D meprof intelbras-default
onu set gpon 8 onu 8 serial-number ITBS2CCFE5FB meprof intelbras-default

onu description add gpon 1 onu 1 text DGT_CAMERA_18_GM
onu description add gpon 1 onu 2 text DGT_CAMERA_15_GM
onu description add gpon 1 onu 3 text DGT_CAMERA_11_GM
onu description add gpon 1 onu 7 text Prefeitura_ponto_temporario
onu description add gpon 1 onu 8 text PREF_CENTRO_INTEGRADO_PROT_MULHER_VLAN_992                                                                                                             _CYBER
onu description add gpon 1 onu 10 text PREF_Coordenadoria_da_mulher_VLAN_991
onu description add gpon 1 onu 11 text PREF_BOMBEIROS_VLAN_989
onu description add gpon 1 onu 12 text PREF_Ginasio_Kurashiki_VLAN_999
onu description add gpon 1 onu 13 text PREF_Deposito_da_SMED_VLAN_987_CYBER
onu description add gpon 1 onu 14 text PREF_URBT_VLAN_931
onu description add gpon 1 onu 15 text PREF_Infectologiao_VLAN_930
onu description add gpon 2 onu 2 text DGT_CAMERA_34_SSP_BM
onu description add gpon 2 onu 3 text MEDIANET_HOSPITAL_1
onu description add gpon 2 onu 4 text DGT_PONTO_16_CAMERA_GM
onu description add gpon 2 onu 5 text CAMERA_DGT_C03
onu description add gpon 2 onu 7 text POWERNET_FabianodaSilva
onu description add gpon 2 onu 8 text BRASIL_SERVICOS_DE_TELECOMUNICACOES_LTDA
onu description add gpon 2 onu 9 text MEDIANET_HOSPITAL_2
onu description add gpon 2 onu 10 text PREF_Abrigo_Meu_Refugio_VLAN_981
onu description add gpon 2 onu 11 text PREF_ESF_Silva_VLAN_902_CYBER
onu description add gpon 2 onu 12 text PREF_HMGV_VLAN_935_CYBER
onu description add gpon 2 onu 13 text PREF_Guarda_Municipal_VLAN_978
onu description add gpon 2 onu 14 text PREF_Secretaria_Municipal_De_Obras_VLAN_9                                                                                                             79_CYBER
onu description add gpon 2 onu 15 text PREF_Defesa_Civil_VLAN_988
onu description add gpon 2 onu 16 text Parque_Mun_De_Eventos_Jayme_Caetano_VLAN_                                                                                                             994
onu description add gpon 2 onu 17 text Vagner_Parahiba_da_Silveira
onu description add gpon 3 onu 1 text DESCONHECIDO
onu description add gpon 3 onu 2 text Moises_Gomes_dos_Santos
onu description add gpon 3 onu 3 text PREF_CLISAM_VLAN_929
onu description add gpon 3 onu 4 text Anne_Caroline_Bandeira_Rutkoski_3
onu description add gpon 3 onu 5 text Maria_Luisa_Vicente_Ferreira
onu description add gpon 3 onu 6 text Junior_Cezar_Rutkoski
onu description add gpon 3 onu 7 text Anne_Caroline_Bandeira_Rutkoski
onu description add gpon 3 onu 8 text Telealarme_5
onu description add gpon 3 onu 9 text Tatiana_Fontoura_Bauer
onu description add gpon 3 onu 10 text Leandro_da_Silveira_Gabriel
onu description add gpon 3 onu 11 text Luciana_Aquino_Borges
onu description add gpon 3 onu 12 text PREF_EMEI_MARA_MATTOS_VLAN_964_CYBER
onu description add gpon 3 onu 13 text PREF_Secretaria_de_Mun_Esporte_e_Lazer_VL                                                                                                             AN_967
onu description add gpon 3 onu 14 text PREF_ESF_Cohab_Casas_VLAN_918
onu description add gpon 3 onu 16 text MIDIANET_FUNDACAO_DE_SAUDE_SAPUCAIA_DO_SU                                                                                                             L_VLAN_3540
onu description add gpon 4 onu 1 text _DGT_GM_PONTO_XXX
onu description add gpon 4 onu 2 text DGT_CAMERA_17_GM
onu description add gpon 4 onu 3 text DGT_CAMERA_21_GM
onu description add gpon 4 onu 4 text Liane_Lucas_Alves
onu description add gpon 4 onu 5 text DGT_SAP_C04
onu description add gpon 4 onu 10 text Bruno_Eduardo_Ribas_ponto_2
onu description add gpon 4 onu 11 text PREF_UBS_COHAB_BLOCOS_VLAN_925_CYBER
onu description add gpon 4 onu 12 text EMEF_Hugo_Gerdau_VLAN_944
onu description add gpon 4 onu 13 text PREF_CRAS_Oeste_VLAN_976
onu description add gpon 4 onu 15 text PREF_EMEF_Primo_Vacchi_VLAN_955_CYBER
onu description add gpon 4 onu 16 text Iran_Leal_Gama
onu description add gpon 4 onu 17 text Diego_Feiber_Rothmundtonu
onu description add gpon 5 onu 1 text Ides_da_Silva_Oliveira
onu description add gpon 5 onu 2 text Diego_Soares_de_Freitas
onu description add gpon 5 onu 3 text William_Martins_da_Silva
onu description add gpon 5 onu 4 text Adrieli_Anequini_Vicente
onu description add gpon 5 onu 5 text Kathleen_Ester_da_Silva_da_Silveira
onu description add gpon 5 onu 7 text PREF_ESF_FORTUNA_VLAN_904
onu description add gpon 5 onu 8 text PREF_EMEF_Otaviano_Silveira_VLAN_951
onu description add gpon 5 onu 9 text EMEI_Hugo_Gerdau_VLAN_961
onu description add gpon 7 onu 1 text Clenio_Djacir_da_Silva
onu description add gpon 7 onu 2 text Leticia_Antonio_Vigano
onu description add gpon 7 onu 3 text Renan_Araujo_Bitello_1
onu description add gpon 7 onu 4 text Renan_Araujo_Bitello_2
onu description add gpon 8 onu 1 text PREF_ESF_Carioca_VLAN_903_CYBER
onu description add gpon 8 onu 2 text Nefab_Embalagens_LTDA
onu description add gpon 8 onu 3 text TELIUM_PONTO_07_TINTAS_KELLING
onu description add gpon 8 onu 4 text RK_GESTAO_E_ASSESSORIA_TELEC_LTDA
onu description add gpon 8 onu 5 text Michele_Mariano_Leal
onu description add gpon 8 onu 6 text Oseas_Souza_da_Rosa
onu description add gpon 8 onu 7 text Graciele_Pooch_dos_Santos
onu description add gpon 8 onu 8 text Catiele_Carvalho_dos_Santos
