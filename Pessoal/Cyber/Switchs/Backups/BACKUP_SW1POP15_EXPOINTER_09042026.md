```yaml
User Authentication
(admin@10.244.189.15) Password:

Info: The max number of VTY users is 10, and the number
      of current VTY users on line is 1.
      The current login time is 2026-04-09 10:34:29-03:00.
Info: Lastest accessed IP: 10.244.254.105  Time: 2026-03-10 15:35:44-03:00  Password will expire in: -

Info: Smart-upgrade is currently disabled. Enable Smart-upgrade to get recommended version information.
<SW1POP15_EXPOINTER>sho
<SW1POP15_EXPOINTER>displ
<SW1POP15_EXPOINTER>display curr
!Software Version V200R022C00SPC500
#
sysname SW1POP15_EXPOINTER
#
router id 10.244.189.15
#
vcmp role client
#
vlan batch 30 150 to 151 1115 1215 1222 1225 3001 3256 4094
#
...
interface Vlanif150
 description VLAN_150_POP15_EXPOINTER_GERENCIA
 l2 binding vsi VSI_150_POP0-2_POP15_EXPOI_MGNT
#
interface Vlanif151
 description VLAN_151_POP15_EXPOINTER_OLT1
 l2 binding vsi VSI_151_POP0-2_POP15_EXPOI_OLT1
#
...
interface XGigabitEthernet0/0/1
 description PTP_SW1POP15_PX01_OLT1POP15_PX01
 port link-type trunk
 undo port trunk allow-pass vlan 1
 port trunk allow-pass vlan 30 150 to 151 3001 3256
 stp disable
 jumboframe enable 12288
#
interface XGigabitEthernet0/0/2
 description PTP_SW1POP15_PX02_SW1POP22_PX02
 port link-type trunk
 undo port trunk allow-pass vlan 1
...
interface XGigabitEthernet0/0/5
 description PTP_SW1POP15_PX05_SW1POP05_PX05
 port link-type trunk
 undo port trunk allow-pass vlan 1
