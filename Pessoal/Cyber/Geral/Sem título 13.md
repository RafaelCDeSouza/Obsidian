...
Info: The max number of VTY users is 10, and the number
      ...
      The current login time is 2026-01-30 12:41:09-03:00.
Info: Lastest accessed IP: 10.244.19.90  Time: 2026-01-22 17:34:22-03:00  Password will expire in: -
...
[SW1POP00_CYBER]display cu
[SW1POP00_CYBER]display current-configuration
!Software Version V200R023C00SPC500
#
sysname SW1POP00_CYBER
#
vlan batch 2 4 10 to 13 16 to 19 21 30 to 31 39 to 41 50 to 51 53 60 to 61
vlan batch 70 to 71 73 80 to 81 83 90 to 91 100 to 101 110 to 111 113 120 to 121 130 to 131
vlan batch 133 141 150 to 151 160 to 161 169 171 173 181 190 to 191 193 to 194
vlan batch 200 to 201 203 211 213 220 250 to 251 253 258 271 273
vlan batch 281 283 905 to 907 912 to 917 919 to 920 922 to 924 926 931 934 936
vlan batch 938 to 942 945 to 949 952 to 953 956 to 960 963 965 to 966 968 970 to 974 977 982
vlan batch 985 to 986 990 1001 1003 1100 1108 1111 to 1112 1121 1125 1138
vlan batch 1144 1152 1164 1166 1195 1264 1295 1395 1914 2311
vlan batch 2340 to 2341 2733 3000 3005 3101 to 3102 3105 to 3108 3111 3114 3119 to 3121 3125
vlan batch 3143 3147 3149 to 3155 3160 3162 to 3163 3166 to 3167 3203 3207 to 3208 3252 3256
vlan batch 3261 3266 3341 3511 3532 to 3533 3540 to 3541 3550 3560 3571 3580 to 3581
vlan batch 3592 3602 3790 to 3791 3902 3904 to 3906 3964 4000 to 4001 4012 4094
#
...
vsi VSI_3560_TRANS_PPPOE_POWERNET static
 ...
 encapsulation ethernet
#
vsi VSI_3125_SHO_POP00_POP25_POWERN static
 pwsignal ldp
  vsi-id 3125
  peer 10.244.188.125
  traffic-statistics enable
...
vsi VSI3904_PNI_META_POP00_CYBER static
 ...
 encapsulation ethernet
#
vsi VSI_3000_CYB_POP00-17_BGP1_BGP1 static
 pwsignal ldp
  vsi-id 3000
  peer 10.244.188.17
 mtu 9000
...
vlan 3125
 description VLAN_3125_BGP1_CYBER_BGP1_POWERNET
vlan 3143
...
aaa
 ...
 domain default_admin
  authentication-scheme default
  accounting-scheme default
 local-user admin password irreversible-cipher $1c$9D,C4\^mIR$(9DcVM_Vy:#=mEF9]il-H;<wNdT"AS[cu5Cm\g-N$
 local-user admin privilege level 15
 local-user admin service-type ssh http
 local-user zandona password irreversible-cipher $1c$WQxs"dqOI;$=3[oQKdEu;~#v!/Y1\/4ZHmmN~E5>=g'7h/Ka2d"$
...
interface Vlanif3000
 description VLAN_3000_BGP1_CYBER_BGP1_SCHOSSLER
 l2 binding vsi VSI_3000_CYB_POP00-17_BGP1_BGP1
#
...
interface Vlanif3125
 description VLAN_3125_BGP1_CYBER_BGP1_POWERNET
 l2 binding vsi VSI_3125_SHO_POP00_POP25_POWERN
#
...
interface Eth-Trunk5
 ...
 port trunk allow-pass vlan 3125 3143 3147 3149 to 3155 3160 3162 to 3163 3166 to 3167 3208 3261 3266
 port trunk allow-pass vlan 3902 3904 to 3906 4000 to 4001
#
interface Eth-Trunk7
 ...
 port trunk allow-pass vlan 200 to 201 203 211 213 253 258 271 273 281 283
 port trunk allow-pass vlan 1001 1111 3511 3541 3571 3581 3602
 jumboframe enable 12288
#
...
interface XGigabitEthernet0/0/15
 ...
 port trunk allow-pass vlan 61 71 81 83 91 101 111 113 133 150 to 151
 port trunk allow-pass vlan 161 171 173 181 193 201 203 251 271 273
 port trunk allow-pass vlan 281 283 915 1111 1395 3005 3103 3105 3107 3111
 port trunk allow-pass vlan 3119 3341 3540 to 3541 3581 3592 3964 to 3965
 jumboframe enable 12288
#
...
interface XGigabitEthernet0/0/23
 ...
 port link-type trunk
 undo port trunk allow-pass vlan 1
 port trunk allow-pass vlan 2 11 17 to 19 2311 3101 to 3102 3105 to 3108 3341 3592 3964
 jumboframe enable 12288
#
